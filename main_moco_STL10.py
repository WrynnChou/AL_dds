...
parser.add_argument("--num_classes", default=200, type=int, help="Number of classes ot be classification")
best_acc1 = 0
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.aug_plus:
        ...
        augmentation = [
            transforms.RandomResizedCrop(224, scale=(0.2, 1.0), interpolation=F.InterpolationMode.BICUBIC),
